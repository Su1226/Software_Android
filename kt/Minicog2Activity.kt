...
class Minicog2Activity : AppCompatActivity() {
    lateinit var m_slide: ViewFlipper
    lateinit var m_btn1: Button;
    lateinit var m_btn2: Button
    lateinit var m_btn3: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_minicog2)
        ...
        m_btn3.setOnClickListener(View.OnClickListener {
            val intent = Intent(this, Minicog2ResultActivity::class.java)
