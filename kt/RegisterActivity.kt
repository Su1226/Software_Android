...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.RBtn1.setOnClickListener{view ->
            if(binding.RegisterName.text.isEmpty() || binding.RegisterPhone.text.isEmpty() || binding.RegisterBirthday.text.isEmpty() || binding.R2Edit0.text.isEmpty() || binding.R2Edit1.text.isEmpty() || binding.R2Edit2.text.isEmpty() || binding.R2Edit3.text.isEmpty() || binding.R2Edit4.text.isEmpty()
