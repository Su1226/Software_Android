...
import com.example.projectteam.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.RBtn1.setOnClickListener{view ->
            if(binding.RegisterName.text.isEmpty() || binding.RegisterPhone.text.isEmpty() || binding.RegisterBirthday.text.isEmpty()) {
