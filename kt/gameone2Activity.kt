...
import kotlinx.android.synthetic.main.activity_gameone.view.*
import java.util.*

class  gameone2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkResult.setOnClickListener{
            if(bbresult==0){
                var toast2 = Toast(this@gameone2Activity)
                toastView = View.inflate(this@gameone2Activity, R.layout.toast2, null)
                ...
                var toast1 = Toast(this@gameone2Activity)
                toastView = View.inflate(this@gameone2Activity, R.layout.toast1, null)
                ...
                var toast3 = Toast(this@gameone2Activity)
                toastView = View.inflate(this@gameone2Activity, R.layout.toast3, null)
